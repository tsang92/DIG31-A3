...
class GroupAPI {
  async getGroup(formData) {
    ...
    // fetch the json data
    const response = await fetch("".concat(_App.default.apiBase, "/group/search/").concat(groupName));
  ...
  async addMember(userId, groupId) {
    ...
    // fetch the json data
    const response = await fetch("".concat(_App.default.apiBase, "/group/").concat(groupId, "/add/").concat(userId), {
      method: 'POST'
    });
    // if response not ok
    if (!response.ok) {
  ...
  async getGroupMessages(groupId) {
    try {
      ...
      const response = await fetch("".concat(_App.default.apiBase, "/group/").concat(groupId, "/messages"));
  ...
  async getGroupMembers(groupId) {
    try {
      ...
      const response = await fetch("".concat(_App.default.apiBase, "/group/").concat(groupId, "/members"));
  ...
  async addMessage(messageId, groupId) {
    ...
    // fetch the json data
    const response = await fetch("".concat(_App.default.apiBase, "/group/").concat(groupId, "/addMessage/").concat(messageId), {
      method: 'POST'
    });
    // if response not ok
    if (!response.ok) {
...
exports.default = _default;
},{"./App":"App.js","./Auth":"Auth.js","./Toast":"Toast.js"}],"views/pages/registerGroup.js":[function(require,module,exports) {
"use strict";
...
class GroupRegisterView {
  ...
  async selectChangeHandler(event) {
    ...
    this.imageSection.style.backgroundImage = "url('/images/".concat(selectedValue, ".jpg')");
  }
  async submitHandler(e) {
    ...
    submitBtn.setAttribute('loading', '');
    try {
      const group = await _GroupAPI.default.getGroup(formData);
      formData.set("group", group._id);
      const updatedUser = await _UserAPI.default.updateUser(_Auth.default.currentUser._id, formData);
      await _GroupAPI.default.addMember(_Auth.default.currentUser._id, group._id);
      this.user = updatedUser;
      _Auth.default.currentUser = updatedUser;
      (0, _Router.gotoRoute)('/');
    } catch (err) {
...
class MessageBoardView {
  ...
  async getMessages() {
    try {
      const user = await _UserAPI.default.getUser(_Auth.default.currentUser._id);
      const messages = await _GroupAPI.default.getGroupMessages(user.group);
      messages.forEach(message => {
        const messageEl = document.createElement('div');
        messageEl.className = 'message-entry';
        messageEl.innerHTML = "\n\n        <a href=\"/message/".concat(message._id, "\"  @click=").concat(_Router.anchorRoute, ">\n\n        <sl-card class=\"card-header\">\n  <div slot=\"header\">\n  <h3>").concat(message.title, "</h3>\n  </div>\n\n  ").concat(message.message, "\n\n</sl-card>\n\n\n       </a>\n        ");
  ...
  render() {
    const template = (0, _litHtml.html)(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n    <style>\n  .card-header {\n    max-width: 300px;\n    color: black;\n    display: inline;\n  }\n\n  .card-header [slot='header'] {\n    display: flex;\n    align-items: center;\n    justify-content: space-between;\n  }\n\n  .card-header h3 {\n    margin: 0;\n  }\n\n  .card-header sl-icon-button {\n    font-size: var(--sl-font-size-medium);\n  }\n\n  .message-entry {\n    margin: 0.5em 0;\n  }\n\n  #result {\n    margin: 0 0 1em;\n  }\n\n  .btn {\n    display: inline;\n  }\n\n  h3 {\n    color: black;\n  }\n\n  .details {\n    font-size: small;\n  }\n  \n\n</style>\n      <va-app-header title=\"Profile\" user=\"", "\"></va-app-header>\n      <div class=\"page-content\">    \n      <div class=\"content\"> \n        <h1 class=\"brand-color\">Message Board</h1>\n        <div id=\"result\"> </div>\n\n        <sl-button @click=", "  type=\"primary\" class=\"btn\" >Add Message</sl-button>\n      </div>      </div>    \n    "])), JSON.stringify(_Auth.default.currentUser), () => (0, _Router.gotoRoute)('/addMessage'));
    (0, _litHtml.render)(template, _App.default.rootEl);
  }
}
var _default = new MessageBoardView();
exports.default = _default;
},{"./../../App":"App.js","lit-html":"../node_modules/lit-html/lit-html.js","./../../Router":"Router.js","./../../Auth":"Auth.js","./../../Utils":"Utils.js","./../../Toast":"Toast.js","./../../UserAPI":"UserAPI.js","./../../GroupAPI":"GroupAPI.js"}],"MessageAPI.js":[function(require,module,exports) {
"use strict";
...
class MesssageAPI {
  async getMessage(messageId) {
    ...
    // fetch the json data
    const response = await fetch("".concat(_App.default.apiBase, "/message/").concat(messageId));
...
class MessageView {
  async init(Id) {
    try {
      ...
      this.messageId = Id;
      const message = await _MessageAPI.default.getMessage(Id);
  ...
  async submitHandler(e, Id) {
    ...
    const formData = e.detail.formData;
    try {
      await _MessageAPI.default.addComment(formData, Id);
      const message = await _MessageAPI.default.getMessage(Id); // Retrieve the updated message
      this.displayMessage(message);
    } catch (err) {
      _Toast.default.show(err, 'error');
    }
  ...
  async displayMessage(message) {
    const author = await _UserAPI.default.getUser(message.author);
    const messageEl = document.createElement('div');
    messageEl.className = 'message-entry';
    messageEl.innerHTML = "\n      <h1 class=\"brand-color\">".concat(message.title, "</h1>\n      <p>").concat(message.message, "</p>\n      <p class=\"details\">Posted by ").concat(author.firstName, " ").concat(author.lastName, " on ").concat(new Date(message.createdAt).toDateString(), "</p>\n    ");
    ...
    const comments = message.comments.map(comment => {
      ...
      messageEl2.innerHTML = "\n\n    <p>".concat(comment.userComment, "</p>\n    <p class=\"details\">Posted by ").concat(comment.author, " on ").concat(new Date(comment.created).toDateString(), "</p>\n    ");
      resultsEl2.append(messageEl2);
    });
  }
  render() {
    const template = (0, _litHtml.html)(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n\n    <style>      \n   \n    .message-entry {\n      border-bottom: solid 3px var(--brand-color);\n \n      margin: 2em 0;\n    }\n    .message-entry2 {\n      border-bottom: solid 1px white;\n      margin: 2em 0;\n    }\n\n    .details {\n      font-size: small;\n    }\n    \n       </style>\n      <va-app-header title=\"Message Detail\" user=\"", "\"></va-app-header>\n      <div class=\"page-content\">      \n        <div class=\"content\"> \n        <div id=\"messageResult\"> </div>\n        <div id=\"result\"> </div>\n        <sl-form class=\"form-signup\" @sl-submit=", ">\n\n            <div class=\"input-group\">\n            <input type=\"hidden\" name=\"author\" value=\"", " ", "\" />\n            <sl-textarea name=\"userComment\" type=\"text\"  placeholder=\"Enter your comment\"></sl-textarea>\n            </div>            \n            <sl-button type=\"primary\" class=\"submit-btn\" submit style=\"width: 100%;\">Submit</sl-button>\n          </sl-form>\n          <p style=\"text-align: center;\"><a href=\"/messageBoard\" @click=", ">Go Back</a></p>\n\n          </div> </div>\n      </div>\n    "])), JSON.stringify(_Auth.default.currentUser), e => this.submitHandler(e, this.messageId), _Auth.default.currentUser.firstName, _Auth.default.currentUser.lastName, _Router.anchorRoute);
    (0, _litHtml.render)(template, _App.default.rootEl);
  }
}
var _default = new MessageView();
exports.default = _default;
},{"./../../App":"App.js","lit-html":"../node_modules/lit-html/lit-html.js","./../../Router":"Router.js","./../../Auth":"Auth.js","./../../Utils":"Utils.js","./../../Toast":"Toast.js","./../../UserAPI":"UserAPI.js","./../../MessageAPI":"MessageAPI.js"}],"views/pages/addMessage.js":[function(require,module,exports) {
"use strict";
...
class AddMessageView {
  ...
  async submitHandler(e) {
    ...
    const formData = e.detail.formData;
    try {
      const message = await _MessageAPI.default.addMessage(formData);
      const groupId = _Auth.default.currentUser.group;
      await _GroupAPI.default.addMessage(message._id, groupId);
      (0, _Router.gotoRoute)('/messageBoard');
    } catch (err) {
      _Toast.default.show(err, 'error');
    }
    submitBtn.removeAttribute('loading');
  ...
  render() {
    const template = (0, _litHtml.html)(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n    <style>      \n   \n\n p {\n  text-align: center\n }\n \n\n    </style>\n      <va-app-header title=\"Message Detail\" user=\"", "\"></va-app-header>\n      <div class=\"page-content \">      \n      <div class=\"content\"> \n          <h1 class=\"brand-color\">Add Message</h1>\n          <sl-form class=\"form-signup\" @sl-submit=", ">\n            <div class=\"input-group\">\n            <input type=\"hidden\" name=\"author\" value=", "  />\n              <sl-input name=\"title\" type=\"text\" placeholder=\"Enter a title\" required></sl-input>\n            </div>\n\n\n            <div class=\"input-group\">\n            <sl-textarea name=\"message\" type=\"text\"  placeholder=\"Enter your message\"></sl-textarea>\n            </div>            \n            <sl-button type=\"primary\" class=\"submit-btn\" submit style=\"width: 100%;\">Submit</sl-button>\n          </sl-form>\n          <p ><a href=\"/messageBoard\" @click=", ">Go Back</a></p>\n\n          </div> </div>\n    "])), JSON.stringify(_Auth.default.currentUser), this.submitHandler, _Auth.default.currentUser._id, _Router.anchorRoute);
    (0, _litHtml.render)(template, _App.default.rootEl);
  }
}
var _default = new AddMessageView();
exports.default = _default;
},{"./../../App":"App.js","lit-html":"../node_modules/lit-html/lit-html.js","./../../Router":"Router.js","./../../Auth":"Auth.js","./../../Utils":"Utils.js","./../../Toast":"Toast.js","./../../GroupAPI":"GroupAPI.js","./../../MessageAPI":"MessageAPI.js"}],"views/pages/team.js":[function(require,module,exports) {
"use strict";
...
class TeamView {
  ...
  render() {
    const template = (0, _litHtml.html)(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n\n    <style>\n    table {\n      border-collapse: collapse;\n      width: 100%;\n    }\n    td, th {\n      border: 1px solid  var(--brand-color);\n      text-align: center;\n      padding: 8px;\n    }\n    \n    tr:nth-child(even) {\n      background-color:  var(--sl-color-secondary-400)\n    }\n    </style>\n\n      <va-app-header title=\"Team\" user=\"", "\"></va-app-header>\n      <div class=\"page-content\">      \n        <div class=\"content\"> \n        <h1 class=\"brand-color\">Team</h1>\n     \n        <div id=\"result\"> </div>\n    \n      </div>\n    "])), JSON.stringify(_Auth.default.currentUser));
    (0, _litHtml.render)(template, _App.default.rootEl);
  }
}
var _default = new TeamView();
exports.default = _default;
},{"./../../App":"App.js","lit-html":"../node_modules/lit-html/lit-html.js","./../../Router":"Router.js","./../../Auth":"Auth.js","./../../Utils":"Utils.js","moment":"../node_modules/moment/moment.js","./../../Toast":"Toast.js","./../../GroupAPI":"GroupAPI.js","./../../UserAPI":"UserAPI.js"}],"Router.js":[function(require,module,exports) {
"use strict";
...
var _registerGroup = _interopRequireDefault(require("./views/pages/registerGroup"));
var _messageBoard = _interopRequireDefault(require("./views/pages/messageBoard"));
var _message = _interopRequireDefault(require("./views/pages/message"));
var _addMessage = _interopRequireDefault(require("./views/pages/addMessage"));
var _team = _interopRequireDefault(require("./views/pages/team"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
// import views
...
const routes = {
  ...
  '/registerGroup': _registerGroup.default,
  '/messageBoard': _messageBoard.default,
  '/message/:id': _message.default,
  '/addMessage': _addMessage.default,
  '/team': _team.default
};
class Router {
  constructor() {
...
},{"./views/pages/home":"views/pages/home.js","./views/pages/404":"views/pages/404.js","./views/pages/signin":"views/pages/signin.js","./views/pages/signup":"views/pages/signup.js","./views/pages/profile":"views/pages/profile.js","./views/pages/editProfile":"views/pages/editProfile.js","./views/pages/guide":"views/pages/guide.js","./views/pages/registerGroup":"views/pages/registerGroup.js","./views/pages/messageBoard":"views/pages/messageBoard.js","./views/pages/message":"views/pages/message.js","./views/pages/addMessage":"views/pages/addMessage.js","./views/pages/team":"views/pages/team.js"}],"App.js":[function(require,module,exports) {
"use strict";
